      ...
      <v-row justify="center">
        <v-col cols="12">
          <v-card
            ...
            height="230px"
            :style="{
              background: 'linear-gradient(to right, ' + firstRandomColorHex +
              ', ' + secondRandomColorHex + ')'}"
            >
            <div
...
<script>
  ...
  import { getRandomPokemonColorHex } from '@/utils/customMethods';
export default {
  data() {
    return {
      pokemonType: 'normal',
      ...
      search_word: null,
      backgroundTypeList: [
        { name: 'normal', width: '450px', height: '350px', margin: '-70px 0px 0px 0px' },
        { name: 'dragon', width: '350px', height: '170px', margin: '90px 0px 0px 1050px' },
        { name: 'ground', width: '350px', height: '200px', margin: '80px 1000px 0px 0px' },
        { name: 'dark', width: '350px', height: '190px', margin: '-120px 900px 0px 0px' },
        { name: 'rock', width: '250px', height: '190px', margin: '-80px 0px 0px 950px' },
        { name: 'grass', width: '350px', height: '150px', margin: '110px 600px 0px 0px' },
        { name: 'fire', width: '350px', height: '200px', margin: '80px 0px 0px 700px' },
        { name: 'electric', width: '250px', height: '150px', margin: '-20px 450px 0px 0px' },
        { name: 'poison', width: '350px', height: '150px', margin: '-70px 0px 0px 530px' },
        { name: 'water', width: '350px', height: '50px', margin: '60px 1090px 0px 0px' },
        { name: 'psychic', width: '350px', height: '90px', margin: '100px 0px 0px 435px' },
        { name: 'steel', width: '350px', height: '70px', margin: '40px 650px 0px 0px' },
        { name: 'bug', width: '350px', height: '50px', margin: '90px 780px 0px 0px' },
        { name: 'fighting', width: '350px', height: '40px', margin: '150px 355px 0px 0px' },
        { name: 'ghost', width: '350px', height: '45px', margin: '100px 0px 0px 870px' },
        { name: 'fairy', width: '350px', height: '40px', margin: '100px 0px 0px 595px' },
      ],
      firstRandomColorHex: getRandomPokemonColorHex(),
      secondRandomColorHex: getRandomPokemonColorHex(),
