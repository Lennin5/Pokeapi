      ...
      <v-container>
            ...
            <v-col
                ...
                :style="{
                    ...
                    <div class="d-flex justify-start align-center container pt-5 ms-3">
                        ...
                        <v-skeleton-loader type="text" class="ms-2" style="width: 30%;"></v-skeleton-loader>
                    </div>
                    <div class="d-flex justify-center align-center container pt-4">
                        <v-skeleton-loader type="card" class="" style="width: 150px; height: 30px;"></v-skeleton-loader>
                    </div>
        ...
        <v-row>
            ...
            <v-card
                ...
                :theme="pokemonType.name === 'flying' ? 'light' : 'dark'"
                max-width="400"
            >
                <div>
                    <v-card-title>
